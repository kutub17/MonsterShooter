...
namespace Environments
{
    ...
    {
        public Forest(Form form) : base(form)
        {
            //Form Background
            this.form.BackgroundImage = Properties.Resources.BG_Forest;
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                playerCoverSpot[i].Image = Properties.Resources.haystack_Forest;
            }
            ...
            for (int index = 0; index < this.enemyHidingBase.Length; index++)
            {
                ...
                enemyHidingBase[index].Image = Properties.Resources.tile_base_forest;
            }
        ...
        protected override PictureBox EnemyHidingSpot()
        {
            ...
            {
                //Stone
                //image.Image = Properties.Resources.tile_bush;
